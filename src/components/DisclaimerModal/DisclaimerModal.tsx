    ...
    if (step === 'disclaimer') {
      return (
        <div>
          <p>Audits: None.</p>
          <p>
            While the initial creators of the idmo protocol have made
      ...
      return (
        <div>
          <p>Attention idmo Uniswap LPs</p>
          <p>
            The only Uniswap pool that is compatible with idmo is idmo/yCRV
            (Curve yPool tokens)
          </p>
